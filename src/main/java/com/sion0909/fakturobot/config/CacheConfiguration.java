package com.sion0909.fakturobot.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sion0909.fakturobot.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sion0909.fakturobot.repository.UserRepository.USERS_BY_EMAIL_CACHE);
