...
import { FakturaComponent } from 'app/entities/faktura/faktura.component';
import { FakturaService } from 'app/entities/faktura/faktura.service';
import { Faktura } from 'app/shared/model/faktura.model';

describe('Component Tests', () => {
  describe('Faktura Management Component', () => {
    let comp: FakturaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FakturaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fakturas && comp.fakturas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
